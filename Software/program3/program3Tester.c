...
int main() {
    ...
    uint16_t testInput1[] = {
        ...
        0b0100101000000000, // Test case 6
        0b0101001000000000, // Test case 7
        0b0001101000000100, // Test case 8
        0b0101101000000100, // Test case 9
        0b0100101000010000, // Test case 10
        0b0110101000001111  // Test case 11
    };
    ...
    uint16_t testInput2[] = {
        ...
        0b0000001000000100, // Test case 7
        0b0001101000000100, // Test case 8
        0b0101101000000100, // Test case 9
    ...
    uint16_t testOutputs[] = {
        0b0001111000000100, // Test case 0
